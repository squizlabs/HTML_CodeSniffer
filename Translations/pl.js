_global.translation['pl'] = {
    ...
    ,"auditor_unable_to_point_entire" : 'Nie można wskazać tego problemu, bo dotyczy całego dokumentu.'
    ,"auditor_unable_to_point_removed" : 'Nie można wskazać tego elementu, bo został usunięty z dokumentu od momentu wygenerowania raportu.'
    ,"auditor_unable_to_point_outside" : 'Nie można wskazać tego elementu, bo znajduje się poza elementem treści dokumentu.'
    ,"auditor_unable_to_point_hidden" : 'Nie można wskazać tego elementu, bo jest niewidoczny lub nie ma reprezentacji wizualnej.'
    ...
    //1_1_1.js
    ,"1_1_1_H30.2" : 'Grafika jest jedyną treścią linku i powinna zostać uzupełniona o tekst alternatywny przedstawiający jego cel.'
    ...
    ,"1_1_1_G94.Image" : 'Upewnij się, że opis alternatywny grafiki przekazuje tę samą informację, co grafika.'
    ,"1_1_1_H36" : 'Przycisk graficzny nie ma atrybutu alt. Dodaj do przycisku atrybut alt i opisz w nim funkcję przycisku.'
    ,"1_1_1_G94.Button" : 'Upewnij się, że tekst alternatywny przycisku prawidłowo opisuje funkcję przycisku.'
    ,"1_1_1_H24" : 'Element "area" w grafaicznej mapie odsyłaczy nie ma atrybutu alt. Każdy taki obszar powinien mieć atrybut alt z tekstem alternatywnym, który odpowiednio opisuje dany obszar.'
    ,"1_1_1_H24.2" : 'Upewnij się, że tekst alternatywny obszaru "area" odpowiada jego funkcji lub treści.'
    ,"1_1_1_G73,G74" : 'Jeśli krótki tekst alternatywny nie opisuje wystarczająco treści prezentowanej przez grafikę, dodaj rozszerzony opis bezpośrednio na stronie lub na oddzielnej stronie.'
    ,"1_1_1_H2.EG5" : 'Tekst alternatywny elementu "img" umieszczonego wewnątrz linku, nie może być taki sam jak tekst samego linku.'
    ...
    ,"1_1_1_H53,ARIA6" : 'Element "object" musi mieć atrybut alt z wprowadzonym opisem alternatywnym, o ile nie został zapewniony żaden inny alternatywny opis tego elementu.'
    ,"1_1_1_G94,G92.Object,ARIA6" : 'Sprawdź, czy krótkie lub długie opisy alternatywne są dostępne dla wszystkich elementów nietekstowych i możliwie najdokładniej je opisują.'
    ...
    ,"1_1_1_H35.2" : 'Applet powinien mieć opis alternatywny w atrybucie alt, aby zapewnić wsparcie w przypadku problemów z załadowaniem treści.'
    ,"1_1_1_G94,G92.Applet" : 'Sprawdź, czy krótkie lub długie długie alternatywne są dostępne dla wszystkich elementów nietekstowych i możliwie najdokładniej je opisują.'
    ...
    //2_4_1.js
    ,"2_4_1_H64.1" : 'Ramka "iframe" musi mieć tytuł. Wypełnij atrybut "title" i umieść w nim opis ramki.'
    ,"2_4_1_H64.2" : 'Tytuł ramki "iframe" powinień opisywać ją w możliwie najdokładniejszy sposób.'
    ,"2_4_1_G1,G123,G124,H69" : 'Sprawdź, czy użytkownik może pominąć powtarzającą się nawigację. Można to zapewnić przez użycie łączy pomijających, nagłówków lub punktów orientacyjnych.'
    ...
    ,"2_4_2_H25.2" : 'Znacznik "title" w sekcji nagłówkowej strony powinien możliwie najdokładniej opisywać jej treść.'
    ...
    //2_5_1.js
    ,"2_5_1.Check" : 'Sprawdź, czy wszystkie funkcje wykorzystujące do obsługi gesty wielopunktowe lub oparte na ścieżce można obsługiwać za pomocą pojedynczego wskazania bez gestu opartego na ścieżce, chyba że gest wielopunktowy lub oparty na ścieżce jest niezbędny.'


    //2_5_2.js
    ,"2_5_2.SinglePointer_Check" : "Sprawdź, czy dla funkcji, które mogą być obsługiwane za pomocą pomocą pojedynczego wskazania, przynajmniej jedno z poniższych jest prawdziwe: \
    ...
    //3_1_1.js
    ,"3_1_1_H57.2" : 'Znacznik "html" musi mieć atrybut "lang" określający język strony.'
    ...
    //3_2_4.js
    ,"3_2_4_G197" : 'Elementy, które mają tę samą funkcjonalność, muszą być zidentyfikowane/oznaczone w ten sam sposób na wszystkich stronach internetowych.'
    ...
    //3_3_5.js
    ,"3_3_5_G71,G184,G193" : 'Sprawdź, czy w formularzu istnieje pomoc kontekstowa na samej stronie lub na stronie służącej do potwierdzenia wprowadzonych treści.'
    ...
    ,"4_1_2_H91.A.NoHref" : 'Link nie powinien być używany do tworzenia wewnętrznych odniesień na stronie. Jeśli identyfikator jest używany do stylów CSS lub oskryptowania JS, rozważ przeniesienie identyfikatora od elementu nadrzędnego (rodzica).'
    ...
    ,"4_1_2_element_content" : 'treść elementu'
    ,"4_1_2_element" : 'element'
    ,"4_1_2_msg_pattern" : 'Element {{msgNodeType}} nie ma prawidłowej nazwy (np. atrybutu) dla API dostępności. Dopuszczalne opcje to: {{builtAttrs}}'
    ,"4_1_2_msg_pattern_role_of_button" : 'element ma rolę "button", ale nie ma prawidłowej nazwy (np. atrybutu) dla "accessibility API". Dopuszczalne opcje to: {{builtAttrs}}'
    ,"4_1_2_msg_pattern2" : 'Element {{msgNodeType}} nie ma wartości, która mogłaby być dostępna dla API dostępności.'
    ...
    ,"4_1_2_value_exposed_using_attribute" : 'Wartość jest eksponowana za pomocą atrybutu {{requiredValue}}.'
    ,"4_1_2_value_exposed_using_element" : 'Wartość jest eksponowana za pomocą elementu {{requiredValue}} .'
