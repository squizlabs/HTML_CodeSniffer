...
var HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_1_1_1_1 = {
    ...
    addNullAltTextResults: function(top)
    {
        ...
        for (var i = 0; i < errors.img.emptyAltInLink.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.img.emptyAltInLink[i], HTMLCS.getTranslation("1_1_1_H30.2"), 'H30.2');
        }

        for (var i = 0; i < errors.img.nullAltWithTitle.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.img.nullAltWithTitle[i], HTMLCS.getTranslation("1_1_1_H67.1"), 'H67.1');
        }

        for (var i = 0; i < errors.img.ignored.length; i++) {
            HTMLCS.addMessage(HTMLCS.WARNING, errors.img.ignored[i], HTMLCS.getTranslation("1_1_1_H67.2"), 'H67.2');
        }

        for (var i = 0; i < errors.img.missingAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.img.missingAlt[i],  HTMLCS.getTranslation("1_1_1_H37"), 'H37');
        }

        for (var i = 0; i < errors.img.generalAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.NOTICE, errors.img.generalAlt[i], HTMLCS.getTranslation("1_1_1_G94.Image"), 'G94.Image');
        }

        for (var i = 0; i < errors.inputImage.missingAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.inputImage.missingAlt[i], HTMLCS.getTranslation("1_1_1_H36"), 'H36');
        }

        for (var i = 0; i < errors.inputImage.generalAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.NOTICE, errors.inputImage.generalAlt[i], HTMLCS.getTranslation("1_1_1_G94.Button"), 'G94.Button');
        }

        for (var i = 0; i < errors.area.missingAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.area.missingAlt[i], HTMLCS.getTranslation("1_1_1_H24"), 'H24');
        }

        for (var i = 0; i < errors.area.generalAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.NOTICE, errors.area.generalAlt[i], HTMLCS.getTranslation("1_1_1_H24.2"), 'H24.2');
        }
    },
    ...
    {
        HTMLCS.addMessage(HTMLCS.NOTICE, element, HTMLCS.getTranslation("1_1_1_G73,G74"), 'G73,G74');
    },
        ...
        if (element.parentNode.nodeName.toLowerCase() === 'a') {
            ...
            if ((nodes.anchor.alt !== null) && (nodes.anchor.alt !== '')) {
                if (HTMLCS.util.trim(nodes.anchor.alt).toLowerCase() === HTMLCS.util.trim(nodes.anchor.text).toLowerCase()) {
                    ...
                    HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("1_1_1_H2.EG5"), 'H2.EG5');
                }
            }
            ...
            if (nodes.anchor.text === '') {
                ...
                if (nodes.next && (nodes.next.href !== '') && (nodes.next.href !== null) && (nodes.anchor.href === nodes.next.href)) {
                    if ((nodes.next.text !== '') && (nodes.anchor.alt === '')) {
                        HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("1_1_1_H2.EG4"), 'H2.EG4');
                    } else if (nodes.next.text.toLowerCase() === nodes.anchor.alt.toLowerCase()) {
                        HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("1_1_1_H2.EG3"), 'H2.EG3');
                    }
                }
    ...
    addMediaAlternativesResults: function(top)
    {
        ...
        for (var i = 0; i < errors.object.missingBody.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.object.missingBody[i], HTMLCS.getTranslation("1_1_1_H53,ARIA6"), 'H53,ARIA6');
        }

        for (var i = 0; i < errors.object.generalAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.NOTICE, errors.object.generalAlt[i], HTMLCS.getTranslation("1_1_1_G94,G92.Object,ARIA6"), 'G94,G92.Object,ARIA6');
        }

        for (var i = 0; i < errors.applet.missingBody.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.applet.missingBody[i], HTMLCS.getTranslation("1_1_1_H35.3"), 'H35.3');
        }

        for (var i = 0; i < errors.applet.missingAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.ERROR, errors.applet.missingAlt[i], HTMLCS.getTranslation("1_1_1_H35.2"), 'H35.2');
        }

        for (var i = 0; i < errors.applet.generalAlt.length; i++) {
            HTMLCS.addMessage(HTMLCS.NOTICE, errors.applet.generalAlt[i], HTMLCS.getTranslation("1_1_1_G94,G92.Applet"), 'G94,G92.Applet');
        }
    },
