...
var HTMLCS_WCAG2AAA_Sniffs_Principle2_Guideline2_4_2_4_1 = {
    ...
    testIframeTitle: function(element)
    {
        ...
        if (nodeName === 'iframe') {
            ...
            if (hasTitle === false) {
                HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("2_4_1_H64.1"), 'H64.1');
            } else {
                HTMLCS.addMessage(HTMLCS.NOTICE, element, HTMLCS.getTranslation("2_4_1_H64.2"), 'H64.2');
            }
        }//end if
    },
    ...
    {
        HTMLCS.addMessage(HTMLCS.NOTICE, top, HTMLCS.getTranslation("2_4_1_G1,G123,G124,H69"), 'G1,G123,G124,H69');
    },
                ...
                try {
                    ...
                    if ((target === null) || (HTMLCS.util.contains(top, target) === false)) {
                        if ((HTMLCS.isFullDoc(top) === true) || (top.nodeName.toLowerCase() === 'body')) {
                            HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("2_4_1_G1,G123,G124.NoSuchID").replace(/\{\{id\}\}/g, id), 'G1,G123,G124.NoSuchID');
                        } else {
                            HTMLCS.addMessage(HTMLCS.WARNING, element, HTMLCS.getTranslation("2_4_1_G1,G123,G124.NoSuchIDFragment").replace(/\{\{id\}\}/g, id), 'G1,G123,G124.NoSuchIDFragment');
                        }
                    }
                } catch (ex) {
                    // Ignore error
