...
var HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_6 = {
    ...
    process: function(element, top)
    {
        ...
        if (rt.length === 0) {
            ...
            if (rb.length === 0) {
                HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("3_1_6_H62.1.HTML5"), 'H62.1.HTML5');
            } else {
                HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("3_1_6_H62.1.XHTML11"), 'H62.1.XHTML11');
            }
        }
        ...
        if (rp.length === 0) {
            ...
            // ruby at all.
            HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("3_1_6_H62.2"), 'H62.2');
        }
    }
};
