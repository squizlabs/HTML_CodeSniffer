...
var HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_2 = {
    ...
    process: function(element, top)
    {
        ...
        HTMLCS.addMessage(HTMLCS.NOTICE, top,  HTMLCS.getTranslation("3_1_2_H58"), 'H58');
            ...
            if ((!langEl.documentElement) && (langEl.nodeName.toLowerCase() !== 'html')) {
                if (langEl.hasAttribute('lang') === true) {
                    ...
                    if (sc3_1_1.isValidLanguageTag(lang) === false) {
                        HTMLCS.addMessage(HTMLCS.ERROR, langEl, HTMLCS.getTranslation("3_1_2_H58.1.Lang"), 'H58.1.Lang');
                    }
                }
                ...
                if (langEl.hasAttribute('xml:lang') === true) {
                    ...
                    if (sc3_1_1.isValidLanguageTag(lang) === false) {
                        HTMLCS.addMessage(HTMLCS.ERROR, langEl, HTMLCS.getTranslation("3_1_2_H58.1.XmlLang"), 'H58.1.XmlLang');
                    }
                }
            }//end if
        }//end for
