...
var HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_1 = {
    ...
    process: function(element, top)
    {
        if ((element.hasAttribute('lang') === false) && (element.hasAttribute('xml:lang') === false)) {
            ...
            HTMLCS.addMessage(HTMLCS.ERROR, element, HTMLCS.getTranslation("3_1_1_H57.2"), 'H57.2');
        } else {
            if (element.hasAttribute('lang') === true) {
                var lang = element.getAttribute('lang');
                if (this.isValidLanguageTag(lang) === false) {
                    HTMLCS.addMessage(HTMLCS.ERROR, top, HTMLCS.getTranslation("3_1_1_H57.3.Lang"), 'H57.3.Lang');
                }
            }
            ...
            if (element.hasAttribute('xml:lang') === true) {
                ...
                if (this.isValidLanguageTag(lang) === false) {
                    HTMLCS.addMessage(HTMLCS.ERROR, top, HTMLCS.getTranslation("3_1_1_H57.3.XmlLang"), 'H57.3.XmlLang');
                }
            }
        }
